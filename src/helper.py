...
class Dataset(object):
    ...
    def __init__(self, dataset_name, data_files):
        ...
        """
        DATASET_CELEBA_NAME_UIUC = 'uiuc_celeba'
        DATASET_CELEBA_NAME = 'celeba'
        DATASET_MNIST_NAME = 'mnist'
        DATASET_CELEBA_NAME_PATCH = 'patch_celeba'
        IMAGE_WIDTH = 28
        IMAGE_HEIGHT = 28
        image_channels = 3
        ...
        elif dataset_name == DATASET_CELEBA_NAME_PATCH:
            IMAGE_WIDTH = 8
            IMAGE_HEIGHT = 8
            self.image_mode = 'RGB'
            image_channels = 3

        elif dataset_name == DATASET_CELEBA_NAME_UIUC:
            IMAGE_WIDTH = 64
            IMAGE_HEIGHT = 64
            self.image_mode = 'RGB'
            image_channels = 3
